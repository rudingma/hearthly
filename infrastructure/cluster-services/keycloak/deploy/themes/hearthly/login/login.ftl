            ...
            <div class="hearthly-social">
                ...
                <div class="hearthly-social-buttons">
                    <#list social.providers as p>
                        <a href="${p.loginUrl}" class="hearthly-social-button hearthly-social-button--${p.alias}" id="social-${p.alias}" data-once-link>
                            <#if p.alias == "google">
                                <svg class="hearthly-social-icon" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
